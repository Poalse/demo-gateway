...
public class PublishModelRequest {
    ...
    private final List<ApiRequest> api;

    public PublishModelRequest(String address, String port, String name_service, String version_service, List<ApiRequest> api) {
